...
const corsOptions = {
  origin: 'https://namaste01.netlify.app',
...
const database = {
  ...
  "patients": [
    ...
    { "id": "P033", "name": "Ananya Kumar", "age": 46, "gender": "F", "symptoms": [], "doctorId": "D006", "visit": { "date": "2025-05-10", "diagnosis": { "system": "ICD-11", "code": "5B20", "description": "Obsessive-compulsive disorder" } } },
...
// --- MAPPING DICTIONARY (WITH FIX) ---
const diseaseMappings = {
  "ICD To NAMASTE": {
    "5B20": [{ "code": "NAM-T-037", "term": "Atatvabhinivesha (OCD)" }],
  ...
  "NAMASTE To ICD": {
    "NAM-T-037": [{ "code": "5B20", "term": "Atatvabhinivesha (OCD)" }],
